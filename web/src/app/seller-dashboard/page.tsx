...
const DashboardContent = React.memo(function DashboardContent() {
  ...
  // Show zero state if no products are listed (only after loading is complete)
  ...
  return (
    <div className="px-3 sm:px-6 py-4 sm:py-8">
      ...
      <div className="mb-6 sm:mb-8">
        <div 
          className="relative overflow-hidden rounded-3xl p-4 sm:p-8 lg:p-10 text-white mb-6 sm:mb-8 shadow-2xl bg-cover bg-center bg-no-repeat"
          style={{
      ...
      <div className="bg-gray-900 rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-800">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-white">{t('frequentlyAskedQuestions')}</h2>
        </div>
        
        <div className="space-y-4">
          <div className="border border-gray-800 rounded-lg p-4">
            <h3 className="font-semibold text-white mb-2">{t('faqQuestion1')}</h3>
            <p className="text-gray-300 text-sm">{t('faqAnswer1')}</p>
          </div>
          
          <div className="border border-gray-800 rounded-lg p-4">
            <h3 className="font-semibold text-white mb-2">{t('faqQuestion2')}</h3>
            <p className="text-gray-300 text-sm">{t('faqAnswer2')}</p>
          </div>
          
          <div className="border border-gray-800 rounded-lg p-4">
            <h3 className="font-semibold text-white mb-2">{t('faqQuestion3')}</h3>
            <p className="text-gray-300 text-sm">{t('faqAnswer3')}</p>
          </div>
          
          <div className="border border-gray-800 rounded-lg p-4">
            <h3 className="font-semibold text-white mb-2">{t('faqQuestion4')}</h3>
            <p className="text-gray-300 text-sm">{t('faqAnswer4')}</p>
          </div>
        </div>
        
        {/* Contact Information */}
        <div className="mt-8 pt-6 border-t border-gray-800">
          <h3 className="font-semibold text-white mb-4">{t('needHelp')}</h3>
          <div className="flex flex-col sm:flex-row gap-4">
            <a 
              href="tel:075251009" 
              className="flex items-center gap-3 px-4 py-3 bg-green-900/30 text-green-300 rounded-lg hover:bg-green-900/50 transition-colors"
            >
            ...
            <a 
              ...
              className="flex items-center gap-3 px-4 py-3 bg-pink-900/30 text-pink-300 rounded-lg hover:bg-pink-900/50 transition-colors"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-4 py-3 bg-purple-900/30 text-purple-300 rounded-lg hover:bg-purple-900/50 transition-colors"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
