        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-whitebg-gray-800 rounded-xl border border-gray-200border-gray-700 shadow-lg p-6 sm:p-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              {/* Terms and Privacy */}
              <div className="text-xs text-center text-gray-500text-gray-400 pt-1 sm:pt-2">
                {t("byContinuing")}{" "}
                <Link
                  href="#"
                  className="underline underline-offset-4 hover:text-gray-700hover:text-gray-300 transition-colors duration-200"
                >
                  {t("termsOfService")}
                </Link>{" "}
                {t("and")}{" "}
