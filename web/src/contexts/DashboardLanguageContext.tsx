...
const dashboardTranslations = {
  mk: {
    ...
    startBuildingStore: "Започнете со градење на вашата продавница со додавање на вашиот прв производ. Објавете производи за да започнете со продавање и да привлечете нови купувачи.",
    noRecentOrders: "Нема неодамнешни нарачки",
    ordersWillAppear: "Нарачките ќе се појават тука кога купувачите ќе започнат да ги купуваат вашите производи. Фокусирајте се на креирање објави за да привлечете купувачи.",
