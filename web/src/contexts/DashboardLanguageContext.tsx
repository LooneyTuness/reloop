...
const dashboardTranslations = {
  mk: {
    ...
    trackProductsDescription: "Управувај со објави",
    ...
    step2ManageListings: "Чекор 2: Управувајте со објавите",
    ...
    keepProductListingsUpdated: "Одржувај ги објавите на производите редовно ажурирани",
    ...
    updateProductListings: "Ажурирај ги објавите на производите",
    ...
    quickReferenceProducts: "Производи - Додавајте и управувајте со вашите објави",
    ...
    addProductDescription: "Додај производ - Прикачи слики, постави цени, напиши описи",
    myListingsDescription: "Мои објави - Уреди, избриши или управувај со производите",
    ...
    // Zero State Messages
    noProductsListedYet: "Сè уште нема објавени производи",
    startBuildingStore: "Започнете со градење на вашата продавница со додавање на вашиот прв производ. Објавите производи за да започнете со продавање и да достигнете купувачи.",
    noRecentOrders: "Нема неодамнешни нарачки",
    ordersWillAppear: "Нарачките ќе се појават тука кога купувачите ќе започнат да ги купуваат вашите производи. Фокусирајте се на создавање одлични објави за да привлечете купувачи.",
    ...
    earningsWillAppear: "Вашата заработка ќе се појави тука кога ќе ја направите вашата прва продажба. Започнете со објавување на производи и привлекување купувачи.",
    viewEarnings: "Види заработка",
    startSelling: "Започни со продавање",
    noViewsYet: "Сè уште нема прегледи",
    productViewsWillAppear: "Прегледите на производите ќе се појават тука кога купувачите ќе започнат да ги прегледуваат вашите објави. Оптимизирајте ги описите и фотографиите на производите за да привлечете повеќе посетители.",
    optimizeListings: "Оптимизирај објави",
    addMoreProducts: "Додај повеќе производи",
    trackProductsThroughSalesFunnel: "Следете ги вашите производи низ продажниот процес",
    manageListings: "Управувај со објави",
    
    // Quick Actions
    addNewProduct: "Додај нов производ",
    viewAllListings: "Види ги сите објави",
    ...
    getStartedByAdding: "Започнете со додавање на вашиот прв производ",
    ...
    // My Listings page
    productListings: "Објави на производи",
    ...
    priceMKD: "Цена (МКД)",
    category: "Категорија",
    selectCategory: "Избери категорија за твојот производ",
    excellent: "Одлично",
    good: "Добро",
    fair: "Пристојно",
    poor: "Со мали траги",
    ...
    createProduct: "Објави производ",
    pleaseUploadAtLeastOneImage: "Ве молиме прикачете најмалку една слика за вашиот производ",
    pleaseProvideBrand: "Ве молиме наведете бренд за вашиот производ",
    productCreatedSuccessfully: "Производот е успешно објавен!",
    failedToCreateProduct: "Неуспешно објавување на производ. Обидете се повторно.",
    ...
    orderTimeline: "Временска линија на нарачката",
    orderInformation: "Информации за нарачката",
    lastUpdated: "Последно ажурирано",
    itemsCount: "Број на производи",
    items: "Производи",
    address: "Адреса",
    ...
    numberOfItems: "Број на производи",
    ...
    unknownProduct: "Непознат производ",
    unknown: "Непознато",
