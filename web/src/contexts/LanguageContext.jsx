...
const translations = {
  mk: {
    ...
    magicLinkWaitXSeconds:
      "Ве молиме почекајте {seconds} секунди пред да побарате друг магичен линк.",
    magicLinkTooManyRequests:
      "Премногу барања. Ве молиме почекајте неколку минути и обидете се повторно.",
    magicLinkInvalidEmail:
      "Неважечка е-пошта. Ве молиме проверете и обидете се повторно.",
    magicLinkNetworkError:
      "Грешка во мрежата. Ве молиме проверете ја вашата врска и обидете се повторно.",
  ...
  en: {
    ...
    magicLinkWaitXSeconds:
      "Please wait {seconds} more seconds before requesting another magic link.",
    magicLinkTooManyRequests:
