...
const translations = {
  mk: {
    ...
    noItemsInOrder: "Нема производи во оваа нарачка",
    // Item conditions
    excellent: "Одлично",
    good: "Добро",
    fair: "Пристојно",
    ...
    deleting: "Се брише...",
    errorDeletingOrder: "Грешка при бришење на нарачката. Обидете се повторно.",
    total: "Вкупно",
    ...
    magicLinkWaitXSeconds: "Ве молиме почекајте {seconds} секунди пред да побарате друг магичен линк.",
    magicLinkTooManyRequests: "Премногу барања. Ве молиме почекајте неколку минути и обидете се повторно.",
    magicLinkInvalidEmail: "Неважечка е-пошта. Ве молиме проверете и обидете се повторно.",
    magicLinkNetworkError: "Грешка во мрежата. Ве молиме проверете ја вашата врска и обидете се повторно.",
  ...
  en: {
    ...
    deleting: "Deleting...",
    errorDeletingOrder: "Error deleting order. Please try again.",
    total: "Total",
    fullName: "Full Name",
    email: "Email",
    phone: "Phone",
    ...
    magicLinkWaitXSeconds: "Please wait {seconds} more seconds before requesting another magic link.",
    magicLinkTooManyRequests: "Too many requests. Please wait a minute and try again.",
    magicLinkInvalidEmail: "Invalid email address. Please check and try again.",
    magicLinkNetworkError: "Network error. Please check your connection and try again.",
