    ...
    <div className="flex flex-col items-center justify-center py-8 sm:py-16 px-4 sm:px-6 text-center">
      ...
      <div className="mb-6 sm:mb-8">
        <div className="relative">
          ...
          <div className="absolute -bottom-1 -left-1 sm:-bottom-2 sm:-left-2 w-5 h-5 sm:w-6 sm:h-6 bg-purple-100 dark:bg-purple-900/20 rounded-full flex items-center justify-center">
            <ShoppingBag className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-purple-600 dark:text-purple-400" />
          </div>
        </div>
      </div>
