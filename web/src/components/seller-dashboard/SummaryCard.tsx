...
export default function SummaryCard({ 
  ...
  return (
    <div className={`group bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 hover:border-blue-200 dark:hover:border-blue-800 ${className}`}>
