      ...
      <div className="flex items-center justify-between h-full px-2 sm:px-8 gap-1 sm:gap-4">
        ...
        <div className="flex items-center gap-3 flex-1">
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-lg bg-gray-900 shadow-md border border-gray-700 hover:shadow-lg transition-all duration-200"
          ...
          <form onSubmit={handleSearch} className="relative">
            ...
            <input
              ...
              className="w-full pl-8 sm:pl-12 pr-8 sm:pr-12 py-2.5 sm:py-2.5 border border-gray-700 rounded-lg sm:rounded-xl bg-gray-900 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm sm:text-sm"
            />
            {searchQuery && (
              <button
                type="button"
          ...
          {showSearchResults && searchQuery && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-gray-900 border border-gray-700 rounded-lg shadow-lg z-[70] max-h-96 overflow-y-auto">
              {isSearching ? (
                ...
                <div className="p-2">
                  ...
                  <div className="space-y-1">
                    <button
                      ...
                      className="w-full text-left px-3 py-2 hover:bg-gray-800 rounded-md text-sm"
                    >
        ...
        <div className="flex items-center space-x-1.5 sm:space-x-3 flex-shrink-0">
          ...
          <div className="relative flex items-center flex-shrink-0 profile-dropdown-container">
            ...
            {/* Profile Dropdown */}
            {showProfileDropdown && (
              <div className="absolute right-0 top-full mt-2 w-64 bg-gray-900 rounded-lg shadow-lg border border-gray-700 z-[70]">
